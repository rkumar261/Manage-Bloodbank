...
public class FXMLReceiverController implements Initializable {
    ...
    private void save(ActionEvent event) {
        ...
        try {
            ...
            ps.setString(7, cbBloodGroup.getValue());
            ps.setString(8, tUnits.getText());
            ps.setString(6, lvCity.getSelectionModel().getSelectedItem());
    ...
    private void loadData(ActionEvent event) {
            ...
            while (rs.next()) {
                data.add(new Receiver(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(7), rs.getString(8), rs.getString(6)));
            }
